...
<a href="work.html"><span>work</span></a>
 ...
 <div class="label cf_">
  <form method="post" autocomplete="off" action="https://caferati.me/">
 <i class="i-svg user" data-icon="user,"></i>
 <label title="Name">Fill in your name</label></div>
 <i class="i-svg common" data-icon="user,"></i>
 <input autocomplete="off" type="text" name="name" placeholder="Fill with your name"/></li>
 ...
 <i class="i-svg common" data-icon="envelope,"></i>
  <input autocomplete="off" type="text" name="email" placeholder="Please enter your email address"/></li>
 ...
 <textarea placeholder="now write your awesome message :)" name="message"></textarea>
 </li>
  <input type="submit" name="submit" value="submit">
  </form>
 </ul>
 <div class="submit"><awesome-button color="teal" width="100" disabled="true">Next</awesome-button><awesome-button color="teal" disabled="true" progress="true">Submit your message</awesome-button></div>
